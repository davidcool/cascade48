...
Button::Button(Mux mux, byte muxpin, byte command, byte value, byte channel, byte debounce)
{
  ...
  Bchannel = channel;
  Btoggle = 0;
  Bmuxpin = muxpin; // added this for 3 & 6 postion switches
}
...
byte temp = _muxpin;
  temp = temp << 1; //Uno 2
  if (_numMuxPins > 8) PORTB = PORTB & B11100001; //Uno PORTD & B11000011
  else PORTB = PORTB & B11110001; //Uno PORTD & B11100011
  PORTB = PORTB | temp;
}
